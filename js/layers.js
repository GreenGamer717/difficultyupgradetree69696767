addLayer("p", {
    ...
    resource: "effortless", // Name of prestige currency
    ...
    hotkeys: [
        {key: "p", description: "P: Reset for effortless", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
    ...
    upgrades: {
        11: {
            title: "The Beginning",
            description: "Begin generating skill",
            cost: new Decimal(1)
        },
        12: {
            title: "Effortless 1",
